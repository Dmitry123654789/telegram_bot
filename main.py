...
async def set_timer(update, context):
    ...
    try:
        ...
        await context.bot.send_message(context.job.chat_id, text=f'Некорректно передано время таймера')
    except IndexError:
        await context.bot.send_message(context.job.chat_id, text=f'Не передано время таймера')
